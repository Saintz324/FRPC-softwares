...
const DATA = {
  pt: {
    ...
    ctaTitle: 'Qual é o seu projeto?',
    ctaSubtitle: 'Ajudamos a criar a solução ideal para a sua empresa — desde a análise ao lançamento, adaptada ao vosso processo real.',
